...
export const ContectText = () => {
  const aboutHighlights = [
    {
      desc: " No need to worry about all the complicated details of studying abroad.",
      tit: "We make it simple!",
    },
    {
      desc: " We won't just send you anywhere - we'll find a program that matches your interests.",
      tit: "We find the perfect fit!",
    },
    {
      desc: " Our team of experienced education experts is here to help.",
      tit: "We're with you all the way!",
    },
  ];
  ...
  return (
    <div>
      ...
      <p className="text-lg">
        Contact <strong> ILM OVERSEAS</strong> today and start your journey with
        confidence!
      </p>
