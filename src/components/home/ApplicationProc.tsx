import { CheckCircle, GraduationCap, Globe, FileCheck } from "lucide-react"
...
></div>
      <div className="max-w-6xl mx-auto z-10 relative  ">
        <h2 className="md:text-5xl text-2xl font-bold text-white text-center mb-12">Application Process</h2>
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex  flex-col items-center">
             ...
             <Image width={300} height={300} src={step.icon}alt="" />
              ...
              <p className="text-white text-2xl font-bold text-center">{step.title}</p>
