  ...
  return (
    <div className="tracking-wider w-11/12 md:px-0 px-2">
      ...
      <ul className="list-disc pl-6 space-y-4 my-4  text-black">
        ...
        <li className="flex items-start">
          <span className="text-lg">
            <strong> We find the perfect fit!</strong> We won{"’"}t just send
            you anywhere – we{"’"}ll find a program that matches your interests.
          </span>
        </li>
        <li className="flex items-start">
          <span className="text-lg">
            <strong>We{"’"}re with you all the way!</strong>  We{"’"}ll be there
            to answer your questions from start to finish
          </span>
        </li>
      </ul>
